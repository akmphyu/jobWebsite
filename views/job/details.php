...
<a href="/web/index.php?r=job" class="btn btn-primary">Back to Job</a>
<span class="pull-right">
    <a href="/web/index.php?r=job/edit&id=<?= $job->id; ?>" class="btn btn-warning">Edit to Job</a>
    <a onclick="return confirm('Are you sure to delete?')" href="/web/index.php?r=job/delete&id=<?= $job->id; ?>" class="btn btn-danger">Delete Job</a>
</span>
<div class="row">
    ...
    ?>
        <li class="list-group-item">
            <strong>Requirement: </strong><?= $job->salary_range; ?>
        </li>
    <?php endif; ?>
